...
def calculate_prec_recall(result,label,iou_thresh):
    ...
    return prec,rec
def calculate_VOC_mAP(result,classnames=None,iou_thresh=0.5,use_07_metric=False):
    '''
    INPUTS:
